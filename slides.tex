...
\begin{frame}{Zykelabbildungen (gerader Fall)}
    ...
    \end{align*}
    die wir die \hil{topologische Zykelabbildung} nennen.

    Ein \hil{geometrischer Lift} der topologischen Zykelabbildung ist eine
...
\begin{frame}
    ...
    beschreiben.
    \begin{block}<2->{Theorem (Existenz von Zykelabbildungen)}
